...
PluginCommand.register("Ollama\Rename all functions", "Rename all functions based on (HLIL)", rename_all_functions_command)
...
PluginCommand.register("Ollama\Settings\Set ollama model", "set the model you want to run", set_model_dialog)

PluginCommand.register("Ollama\Settings\Set ollama server", "set the server where you want to access ollama", set_server_dialog)
